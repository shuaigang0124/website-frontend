        ...
        <el-row>
          ...
          <el-col :span="15">
            <div
              ...
              "
            >
              <i class="el-icon-s-promotion" style="color: yellow"></i
              >发布日常分享
            </div>
          </el-col>
          <el-col :span="4">
      ...
      <el-main class="detail-main">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-row>
              <el-col :span="3">
                <b style="color: #f56c6c; margin-right: 8px">*</b>
                预览图：
              </el-col>
              <el-col :span="21">
                <el-upload
  ...
  setup() {
    ...
    const request = {
      ...
      release() {
        ...
        let userId = localStorage.getItem("shuaigangOVO");
        if (userId) {
          state.releaseData.userId = Base64.decode(userId);
        }
        if (!state.releaseData.img) {
          state.releaseData.img =
            "/gsg/static-resource/formal/2/20211217/1639723063241-1537672686871583.webp";
        }
        // 请求体数据
        const data = {
          customData: state.releaseData,
        };

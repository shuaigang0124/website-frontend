  ...
  <div id="year" v-cloak>
    <div style="padding-bottom: 10px">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>年份管理</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <div style="margin-top: 15px">
      ...
      >
        <el-form
          ...
          class="demo-ruleForm"
        >
          <el-form-item label="年份：" prop="id">
            <el-input v-model="addDiaryForm.id" />
          </el-form-item>
          <el-form-item label="标题：" prop="title">
            <el-input v-model="addDiaryForm.title" />
          </el-form-item>
          <el-form-item label="标题描述：" prop="content">
            <el-input v-model="addDiaryForm.content" />
          </el-form-item>
    ...
    <el-table :data="diaryData" border style="width: 100%; margin-top: 15px">
      ...
      <el-table-column label="年份" prop="id" />
      <el-table-column label="标题" prop="title" />
      <el-table-column label="标题描述" prop="content" show-overflow-tooltip />
        ...
        <template #default="scope">
          ...
          >
            ...
            >
              ...
              <el-form-item label="标题描述：" prop="content">
                <el-input v-model="diaryForm.content" />
              </el-form-item>
              <el-form-item align="center">
                <span class="dialog-footer">
                  <el-button @click="cancelUpdate">取消</el-button>
                  <el-button type="primary" @click="updateYear"
                    >确定</el-button
                  >
                </span>
              </el-form-item>
  ...
  setup() {
    ...
    const methods = {
      ...
      updateEvent(row) {
        ...
        state.diaryForm.id = row.id;
        state.diaryForm.title = row.title;
        state.diaryForm.content = row.content;
